...
/**
 * Le composant BannerFooter affiche une bannière de pied de page avec des témoignages.
 * Il inclut une image de fond, un titre, une description, et une série de témoignages de partenaires.
 * Chaque témoignage se compose d'un logo, d'un nom de partenaire, et d'une citation d'un représentant.
 *
 * @returns {JSX.Element} Le composant BannerFooter rendu.
 */
export default function BannerFooter() {
  return (
    <div className="relative flex flex-col justify-center items-center px-16 py-20 min-h-[505px] max-md:px-5 overflow-hidden">
