...
//             {/* Desktop Actions with SearchBar */}
...
const styles = {
  ...
  searchBar: "relative hidden lg:flex items-center",
  mobileSidebar: {
    overlay: "fixed inset-0 bg-black bg-opacity-90 z-40 transition-opacity duration-300", // Superposition sombre
    container: "fixed top-0 left-0 h-full w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 backdrop-blur-md", // Ajout de l'effet flou
