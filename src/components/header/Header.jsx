...
//               <img src="https://res.cloudinary.com/dqrs3xyic/image/upload/v1712325532/logo.svg"
//                 alt="Agroconnect" className="h-12  mt-10 mb-4 md:h-16" />
//             </div></NavLink>
...
// export default function Header() {
//   const [isMenuOpen, setIsMenuOpen] = useState(false);
//   const [prevScrollPos, setPrevScrollPos] = useState(window.scrollY); // Modification ici
//   const [visible, setVisible] = useState(true);

//   useEffect(() => {
//     const handleScroll = () => {
//       const currentScrollPos = window.scrollY; // Modification ici
//       setVisible(prevScrollPos > currentScrollPos || currentScrollPos < 5);
//       setPrevScrollPos(currentScrollPos);
//     };
